...
Entre janeiro e abril de 2025, a ferramenta de regras de associação em conjunto com a ferramenta de [clusterização]([https://github.com/letandrade/regras_de_associacao_glosas_hospitalares](https://github.com/letandrade/clusterizacao_glosas_hospitalares)) identificaram 37 casos relevantes de glosas somando aproximadamente R$5 milhões, cuja tratativa resultou em uma glosa evitada anualizada de aproximadamente R$60 milhões.
